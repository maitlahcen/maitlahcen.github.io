...
* A projection algorith applied to the Lucas asset pricing model: 
...
* A version of the Paramterized Expectation Algorithm applied to the Neoclassical Growth Model: 
